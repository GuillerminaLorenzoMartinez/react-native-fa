...
## Emulators 
This app can be run on your mobile phone (downloading the app ExpoGo) or through an emulator on your computer. 
- For iOS we recommend using Xcode
- For Android we recommend using Android studio

## Running the App
Run `npx expo start` to run the project, if that doesn't work, try running `npx expo start --tunnel` to run the project.

Scan the QR code in the terminal with your phone's camera and it will open the app in the Expo Go app.
